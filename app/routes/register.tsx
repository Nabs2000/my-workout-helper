...
export default function Register() {
    ...
    async function registerAndCreateProfile(firstName: string, lastName: string, email: string, password: string) {
      try {
        ...
        console.error("Error during registration or profile creation:", errorCode, errorMessage);
    ...
    return (
        <div>
          <h1>Register</h1>
            <Form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" onSubmit={(e) => registerAndCreateProfile(firstName, lastName, email, password)}>
                <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="firstName">
                    First Name
                </label>
                <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="firstName" type="text" placeholder="First Name" value={firstName} onChange={(e) => setFirstName(e.target.value)} />
                </div>
                <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="lastName">
                    Last Name
                </label>
                <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="lastName" type="text" placeholder="Last Name" value={lastName} onChange={(e) => setLastName(e.target.value)} />
                </div>
                <div className="mb-4">
